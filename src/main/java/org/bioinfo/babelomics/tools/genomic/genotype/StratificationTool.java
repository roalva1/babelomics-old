...
public class StratificationTool extends GenotypeAnalysisTool {
	...
	public void initOptions() {
		options.addOption(OptionFactory.createOption("ibs-cluster", "To perform complete linkage clustering of individuals on the basis of autosomal genome-wide SNP data", true, false));
