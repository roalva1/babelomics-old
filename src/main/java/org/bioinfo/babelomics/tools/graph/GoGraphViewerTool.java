	...
	protected void execute() {		
		...
		try {
			...
			if(config!=null){
				...
				// init graph api
				GetGraphApi graph = new GetGraphApi(outdir + "/",PREFIX,new File(associationFile).getName(),goDomain,idsPerNodeFilter,graphColoring,annotScoreParameter,annotScoreNodeFilter, "orange",6,"title");
